...
import {Separator} from "./../../../../../packages/ui/src/shad/ui/separator";
...
export const Auth = ({ type }: { type: "signup" | "signin" }) => {
    const [text, setText] = useState<'signin' | 'signup'>(type);
        ...
        <div className="flex flex-center h-screen">
            ...
            >
                <div className="flex flex-col gap-12">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="min-w-[10vw] flex gap-2 p-2 font-medium md:text-lg rounded-xl hover:-translate-y-2 transition-all duration-300 cursor-pointer bg-gradient-to-b from-blue-400 to-blue-700 text-white justify-center">
                        ...
                        <div className="min-w-[20vw] flex gap-2 p-2 font-medium md:text-lg rounded-xl hover:-translate-y-2 transition-all duration-300 cursor-pointer bg-gradient-to-b from-blue-400 to-blue-700 text-white justify-center">
            ...
            <div className="flex items-center gap-2 cursor-pointer mx-auto">
                <div className="flex flex-col justify-center items-center tracking-tighter text-md md:text-sm" 
                    onClick={()=>{
                        setText(text === 'signin' ? 'signup' : 'signin')
                    }}
                >
                    {text === 'signin' ? <p>No Account? <u> Create One</u></p> : <p>Already have an account? <u> sign in</u></p>}
                </div>
            </div>
          <Separator className="w-full my-2" />
          <Link to={"/"} className="flex items-center gap-2 cursor-pointer mx-auto">
            <div className="flex flex-col justify-center items-center tracking-tighter text-md md:text-sm">
                <p className="text-pretty md:text-balance">Click “Sign up” to agree to Channel's <u> Terms of Service </u> and acknowledge that </p>
