    ...
    <div className="flex flex-col items-center mt-20 relative [background:radial-gradient(125%_100%_at_50%_0%,_#FFF_6.32%,_#EOFOFF_29.28%,_#E7EFFD_68.68%,_FFF_100%)]">
      ...
      <div className="relative z-10  mx-auto px-4 py-16">
        ...
        {/* <div className="text-center mb-20">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">A complete blogging platform</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Why use Feather with Notion for creating your blog? Feather is a simple yet powerful platform that helps
            create a superfast blog with Notion as a CMS. It's just set and forget!
          </p>
        </div> */}
