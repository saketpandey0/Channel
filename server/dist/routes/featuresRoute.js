...
router.put("/story/comments/:id", featuresController_1.updateComment);
router.delete("/story/comments/:id", featuresController_1.deleteComment);
router.post("/story/comments/:id/reply", featuresController_1.replycomment);
router.post("/story/comment/:id/clap", featuresController_1.toggleCommentClap);
...
router.get("/story/:id/bookmarks", featuresController_1.getStoryBookmarks);
