...
const Stories: React.FC<StoriesProps> = ({
  ...
  return (
    <article
      className="relative z-10 rounded-xl shadow-sm transition-all duration-300 border border-gray-100 overflow-hidden group cursor-pointer shadow-slate-700/50 hover:shadow-lg bg-slate-100"
      onClick={onClick}
    >
